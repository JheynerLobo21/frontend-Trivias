...
export function LightBulb({position, tipo}) {
  return (
    <div className={`light-bulb ${tipo}`} style={position}>
      <svg width="76px" className={!tipo?"position-foco":''} height="94px" viewBox="0 0 76 94" id="bulb">
      ...
      <div id="glow" className={!tipo?"position-foco":''}></div>
      <svg width="32px"  height="33px" viewBox="0 0 32 33" id="base" className={`${tipo}2`}>
