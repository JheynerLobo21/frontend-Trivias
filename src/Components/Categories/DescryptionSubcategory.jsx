...
export const DescryptionSubcategory = ({ btnSubcategory }) => {
  ...
  if (!primera) subcategory = btnSubcategory.name.replace(/ /g, "-");
  ...
  return (
    <section className="description-subCategory">
      <h2 className="title-subcategory">
        {!primera ? btnSubcategory.name : ""}
      </h2>
      <div className="description-img">
        <img src="" alt="" className="img-carrusel" />
        <p className="description-subcategory">
          {!primera ? btnSubcategory.description : ""}
        </p>
      </div>
      <div>
