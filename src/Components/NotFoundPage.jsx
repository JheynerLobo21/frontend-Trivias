...
export const NotFoundPage = () => {
  return (
    ...
    <div className="notFound">
      <section className="notFound-lightBulb">
        <div className="frameLightBulb">
          <svg
            viewBox="0 0 76 94"
            id="bulb-breacked"
          >
          ...
          <label className="label4-1" >4</label>
          <label className="label4-2" >4</label>
         
          <div id="glow-breaked" className="position-foco"></div>
          <svg viewBox="0 0 32 33" id="base-breacked">
      ...
      <section className="notFound-message">
        <label className="oops">¡Oops...</label>
        <label className="menssage">
          Algo se ha roto<label className="admiral-sign">!</label>, ¿Quieres
          repararlo?
        </label>
        <a className="btn-5" href="http://localhost:5173/">
          Reparar
        </a>
      </section>
    </div>
